...
class ConditionalRuleset {
  ...
  getSortedRuleset() {
    ...
    var sortedRuleset = []; // Loop through all queries and add them to the sorted ruleset
...
class Stylesheet {
  constructor(localClassNames, composedClassLists) {
    ...
    this.localClassNamesSearch = new AhoCorasick__default["default"](localClassNames); // Class list compositions should be priortized by Newer > Older
  ...
  transformSelector(selector) {
    ...
    var lastReplaceIndex = transformedSelector.length; // Perform replacements backwards to simplify index handling
    ...
    for (var i = results.length - 1; i >= 0; i--) {
      ...
      lastReplaceIndex = startIndex; // If class names already starts with a '.' then skip
