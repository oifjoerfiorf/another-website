...
class EditorInterfaces {
    ...
    update(fieldId, widgetId, settings, widgetNamespace) {
        ...
        if (((_a = this._editorLayout) === null || _a === void 0 ? void 0 : _a.length) > 0) {
            const fieldIdIsNotPresentInExistingEditorLayout = !(0, editor_layout_1.find)(this._editorLayout, (editorLayoutItem) => (0, editor_layout_1.isFieldItem)(editorLayoutItem) && editorLayoutItem.fieldId === fieldId);
