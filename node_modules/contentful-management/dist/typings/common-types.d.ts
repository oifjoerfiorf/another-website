...
export declare type EnvironmentTemplateParams = {
    spaceId: string;
    environmentId: string;
    environmentTemplateId: string;
};
export declare type GetAppActionParams = GetAppDefinitionParams & {
    appActionId: string;
};
export declare type GetAppActionsForEnvParams = GetSpaceParams & {
    environmentId?: string;
};
export declare type GetAppActionCallParams = GetAppInstallationParams & {
    appActionId: string;
};
...
export declare type GetAppInstallationsForOrgParams = GetOrganizationParams & {
    appDefinitionId: string;
};
...
export declare type GetEnvironmentTemplateParams = GetOrganizationParams & {
    environmentTemplateId: string;
};
...
export declare type GetOrganizationMembershipParams = GetOrganizationParams & {
    organizationMembershipId: string;
};
export declare type GetAppUploadParams = GetOrganizationParams & {
    appUploadId: string;
};
export declare type GetWorkflowDefinitionParams = GetSpaceEnvironmentParams & {
    workflowDefinitionId: string;
};
export declare type GetWorkflowParams = GetSpaceEnvironmentParams & {
    workflowId: string;
};
export declare type GetUIConfigParams = GetSpaceEnvironmentParams;
export declare type GetUserUIConfigParams = GetUIConfigParams;
export declare type QueryParams = {
    query?: QueryOptions;
};
export declare type SpaceQueryParams = {
