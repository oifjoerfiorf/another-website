...
export declare type PlainClientAPI = {
    ...
    comment: {
        ...
        getMany(params: OptionalDefaults<GetEntryParams & QueryParams>): Promise<CollectionProp<CommentProps>>;
...
export declare type AlphaWorkflowExtension = {
    workflowDefinition: {
...
export declare type AlphaExtensions = AlphaWorkflowExtension;
export declare type AlphaPlainClientAPI = PlainClientAPI & AlphaWorkflowExtension;
