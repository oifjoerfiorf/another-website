...
export default function createEnvironmentApi(makeRequest: MakeRequest): {
    ...
    createAppInstallation(appDefinitionId: string, data: CreateAppInstallationProps, { acceptAllTerms }?: {
        acceptAllTerms?: boolean | undefined;
     ...
     * ```
     */
    getReleases(query?: ReleaseQueryOptions | undefined): Promise<import("./common-types").CursorPaginatedCollection<import("./entities/release").Release, import("./entities/release").ReleaseProps>>;
    /**
