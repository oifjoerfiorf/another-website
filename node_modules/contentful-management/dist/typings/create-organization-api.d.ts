...
export default function createOrganizationApi(makeRequest: MakeRequest): {
    ...
    createAppAction(appDefinitionId: string, data: CreateAppActionProps): Promise<({
        category: import("./entities/app-action").AppActionCategoryType.EntriesV1 | import("./entities/app-action").AppActionCategoryType.NotificationV1;
    } & {
        ...
        category: import("./entities/app-action").AppActionCategoryType.Custom;
