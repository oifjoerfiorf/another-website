...
export const getManyForOrganization = (http, params) => raw.get(http, `/organizations/${params.organizationId}/team_memberships`, {
  params: normalizeSelect(params.query)
});
export const getManyForTeam = (http, params) => {
...
export const del = (http, params) => raw.del(http, getEntityUrl(params));