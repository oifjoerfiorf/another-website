 ...
 * @private
 */
export const createPlainClient = (makeRequest, defaults, alphaFeatures) => {
  const wrapParams = {
    makeRequest,
    defaults
  };
...
const addAlphaFeatures = (makeRequest, defaults, alphaFeatures) => {
  ...
  if (alphaFeatures !== null && alphaFeatures !== void 0 && alphaFeatures.includes(ALPHA_FEATURE_WORKFLOWS)) {
